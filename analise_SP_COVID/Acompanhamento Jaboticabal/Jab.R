...
ggplotly(ggplot(mun) + 
           ...
           geom_line(col = 'darkred') +
           labs(x = '', y = "Novos Óbitos", title = "Gráfico média dos Novos Óbitos no Município de São Paulo") +
           theme_bw() +
           theme(plot.title = element_text(hjust = 0.5))
)
...
ggplotly(ggplot(mun) +
           ...
           geom_col(color = "black", fill = 'darkred') +
           labs(x = '', y = "Novos Casos", title = "Gráfico média dos Novos Casos no Município de São Paulo") +
           theme_bw() +
           theme(plot.title = element_text(hjust = 0.5))
)